...
exports.accelerateX = function (value) {
    return {
        type: 'PLAYER_ACCELERATE_X', value: value
    };
};

exports.accelerateY = function (value) {
    return {
        type: 'PLAYER_ACCELERATE_Y', value: value
    };
};
...
var _require = require('./actions/player');

var accelerateX = _require.accelerateX;
var accelerateY = _require.accelerateY;


module.exports = function (dispatch) {
    var X = function X(val) {
        return function () {
            return dispatch(accelerateX(val));
        };
    };
    var Y = function Y(val) {
        return function () {
            return dispatch(accelerateY(val));
        };
    };
    key.bind('up', Y(-1), Y(0));
...
},{"./actions/player":7,"keyboardjs":1}],9:[function(require,module,exports){
(function (global){
'use strict';
...
},{"./input-events":8,"./reducers/player":10,"./store":11,"morphdom":6}],10:[function(require,module,exports){
'use strict';
...
var clamp = function clamp(value, precision) {
    return (value * precision | 0) / precision;
};

var step = function step(player) {
    var x = player.x;
    var y = player.y;
    var speedX = player.speedX;
    var speedY = player.speedY;
    var accelX = player.accelX;
    var accelY = player.accelY;
